...
- **Backend:** Node.js, REST APIs, Prisma ORM
- **Database & Cloud:** Firebase (Auth, Firestore, Hosting)
- **Tools:** Git, GitHub, Vite

## 🚀 Featured Projects

### 📊 [Manasra ERP — Attendance & Payroll System](https://github.com/bilal-qunaibe/manasra-erp-system)
...
- Role-based authentication with Firebase Auth and Firestore security rules
- Automatic working-hours and overtime calculation
- Real-time attendance dashboard

**Tech:** React · TypeScript · Firebase (Auth, Firestore)

### 💰 [LuxeBloom — Accounting & Inventory System](https://github.com/bilal-qunaibe/luxebloom-accounting-system)
...
- Full-stack architecture: React frontend + Node.js API + Prisma ORM
- Inventory tracking with quantities and item types
- Sales recording with automatic totals
...
- 💼 **LinkedIn:** [linkedin.com/in/bilal-qunaibe](https://www.linkedin.com/in/bilal-qunaibe-854304408/)
